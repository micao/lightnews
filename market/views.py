    ...
    try:
        ...
        if not FundingDeal.objects.exists():
            seed_deals = [
                ...
                {'company': 'Mistral AI', 'round': 'B轮', 'amount': '6亿欧元', 'investor': 'DST Global, General Catalyst', 'sector': '人工智能'},
                {'company': 'Cohere', 'round': 'D轮', 'amount': '5亿美元', 'investor': '英伟达、甲骨文与Salesforce', 'sector': 'AI 基础设施'},
